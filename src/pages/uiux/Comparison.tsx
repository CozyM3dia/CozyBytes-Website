...
export default function Comparison() {
  const [active, setActive] = useState<CompetitorKey>('agency')
  const activeLabel =
    ...
    <section className="relative border-t border-white/[0.06] py-24 md:py-32">
      <div className="mx-auto max-w-6xl px-5 md:px-8">
        <SectionHeading
          ...
          deck="Perbedaan terbesar bukan pada keindahan visual, melainkan kerapian aset dan kemudahan handoff ke programmer."
        />
        ...
        >
          <table className="w-full border-collapse text-left">
            <caption className="sr-only">
              Perbandingan layanan desain Cozybytes dengan agensi besar, desainer freelancer, dan
              tema instan
            </caption>
            <thead>
