...
export default function Comparison() {
  const [active, setActive] = useState<CompetitorKey>('marketplace')
  const activeLabel =
        ...
        <SectionHeading
          ...
          title={
            <>
              ...
              <span className="font-serif italic text-white/35">Shopify, dan WooCommerce.</span>
            </>
          }
          deck="Nilai yang sama dibandingkan empat jalur jualan â€” angka komisi dan kepemilikan data menjadi pembeda utama."
        />
        ...
        >
          <table className="w-full border-collapse text-left">
            <caption className="sr-only">
              Perbandingan toko online Cozybytes dengan marketplace, Shopify SaaS, dan WooCommerce
            </caption>
            <thead>
              <tr className="border-b border-white/[0.09] bg-white/[0.02]">
                <th
                  scope="col"
                  className="p-5 font-mono text-[11px] font-semibold uppercase tracking-[0.2em] text-white/35"
                >
                  Faktor Evaluasi
                </th>
              ...
              <div key={row.aspect} className="p-5">
                ...
                <div className="mt-3.5 space-y-3">
                  <div className="flex gap-2.5 rounded-xl border border-[#00FFFF]/18 bg-[#00FFFF]/[0.05] p-3">
                    <Check className="mt-0.5 h-3.5 w-3.5 shrink-0 text-[#00FFFF]" strokeWidth={2.5} />
                    <div>
                      <span className="block text-[11px] font-bold uppercase tracking-wider text-[#00FFFF]/70">
                        Cozybytes
                      </span>
                  ...
                  <div className="flex gap-2.5 rounded-xl border border-white/[0.07] bg-white/[0.012] p-3">
                    ...
                    <div>
                      <span className="block text-[11px] font-bold uppercase tracking-wider text-white/35">
                        {activeLabel}
                      </span>
