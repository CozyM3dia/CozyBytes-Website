...
/** Ikon plus yang bermorf jadi minus — dua garis, satu berputar. */
...
function FaqRow({
  ...
  return (
    <div className="group relative border-b border-white/[0.07]">
      {/* Sapuan cyan tipis saat hover / terbuka */}
      <span
        aria-hidden
        ...
        style={{
          background:
            'linear-gradient(to right, rgba(0,255,255,0.045) 0%, transparent 55%)',
        }}
      />
      <span
        aria-hidden
        ...
        >
          <span
            className={`mt-1 font-mono text-[11px] tabular-nums transition-colors duration-300 ${
              open ? 'text-[#00FFFF]' : 'text-white/25'
            }`}
          >
      ...
      {/*
        ...
        selalu ada di HTML — penting karena FAQ ini juga dipakai untuk
    ...
    <section className="relative py-24 md:py-32">
      <div className="mx-auto max-w-6xl px-5 md:px-8">
        <div className="grid gap-14 lg:grid-cols-12 lg:gap-12">
          {/* ---------- Kolom kiri: heading + nudge kontak ---------- */}
              ...
              <SectionHeading
                ...
                title={
                  <>
                    Pertanyaan{' '}
                    <br />
                    <span className="font-serif italic text-[#00FFFF]">yang sering</span>{' '}
                    <br />
                    kami dengar.
                  </>
                }
